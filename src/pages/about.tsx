      ...
      <section className='flex justify-center flex-col'>
        <div>
          ...
          <p className='mt-4 text-lg leading-relaxed text-justify'>
            ...
            at no cost. Using FCM, you can notify a client app that new email or other data is available to sync. You
            can send notification messages to drive user re-engagement and retention. For use cases such as instant
            messaging, a message can transfer a payload of up to 4KB to a client app.
          </p>
        </div>
        <div className='mt-16'>
          ...
          <table className='table-auto w-full text-md text-left leading-relaxed whitespace-no-wrap mt-6'>
            <tbody>
              ...
              <tr className='border-t-2 border-gray-300'>
                ...
                <td className='p-6'>
                  Send acknowledgments, chats, and other messages from devices back to your server over FCM’s reliable
                  and battery-efficient connection channel.
                </td>
              </tr>
            </tbody>
          </table>
